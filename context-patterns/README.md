...
This is the **reference catalog** for the Context Patterns recipe collection. Use it when you need the full picture — deep-dive patterns, curated resources, and architecture examples.
